...
#if !defined(unix) && !defined(__unix__) && !defined(__unix) && !defined(__APPLE__) && !defined(_WIN32) && !defined(__QNXNTO__) && !defined(__HAIKU__) && !defined(__midipix__)
...
#if defined(__socklen_t_defined) || defined(_SOCKLEN_T) || defined(_SOCKLEN_T_DECLARED) || defined(__DEFINED_socklen_t) || defined(socklen_t) || (defined(_POSIX_VERSION) && _POSIX_VERSION >= 200112L)
